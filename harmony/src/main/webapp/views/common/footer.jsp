						...
						<div class="w-full mb-8 overflow-hidden rounded-lg shadow-xs">
							<div class="row row-cols-2">
								<div class="col-4 list-group px-3 py-1" id="messageListContainer" >
									<div class="list-group-item list-group-item-action message d-flex flex-row" style="align-items: center;">
									    <div>
									    ...
									    <div class="px-2 d-flex flex-column">
									    	<span class="px-2 text-nowrap" style="border-radius: 9999px; background-color: green;">demo text</span>
									    	<span>demo text</span>
									    </div>
									</div>
								</div>
