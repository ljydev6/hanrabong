	          	...
	          	<div class="card col" id="card_<%=c.getCrslNo()%>">
	          		<form method="post" enctype="multipart/form-data" class="align-items-center">
	          			<div class="card-header input-group input-group-sm">
          					...
          					<input class="form-control" type="text" name="pagelink" placeholder="이름을입력해주세요" value="<%=c.getCrslName()%>">
	          			</div>
		          		...
		          		<ul class="list-group list-group-flush">
		          			<li class="list-group-item">
		          				<div class="input-group input-group-sm">
			          				...
			          				<input class="form-control" type="file" name="newImage" placeholder="이미지변경시에만 입력해주세요" accept="image/*">
			          			</div>
		          			</li>
		          			<li class="list-group-item">
		          				<div class="input-group input-group-sm">
		          			...
		          			<li class="list-group-item">
		          				<div class="row justify-content-between">
                        			...
                        			<%break;} %>
			          				...
			          				<div class="col-2 flex justify-content-end text-sm">
			          				  <button type="button"  class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray" name="resetBtn" aria-label="Edit">
			                            <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-arrow-repeat" viewBox="0 0 20 20">
