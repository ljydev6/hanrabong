        ...
        <div class="flex flex-col overflow-y-auto md:flex-row">
          <div class="h-32 md:h-auto md:w-1/2">
            <img
              ...
              src="<%=request.getContextPath() %>/views/admin/assets/img/login-office.jpeg"
              alt="Office"
            />
            <img
              aria-hidden="true"
              class="hidden object-cover w-full h-full dark:block"
              src="<%=request.getContextPath() %>/views/admin/assets/img/login-office-dark.jpeg"
              alt="Office"
            />
          </div>
