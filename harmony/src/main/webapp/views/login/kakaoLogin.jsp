...
<%--  function kakaoLogin() {
 ...
 --%>
function kakaoLogin() {
	location.href = 'https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=7a71de50fa7db8d6bb2395a8a5fba504&redirect_uri=http://14.36.141.71:10010/GDJ71_harmony_semi/member/kakaoLogin.do';
}
//카카오로그아웃  
